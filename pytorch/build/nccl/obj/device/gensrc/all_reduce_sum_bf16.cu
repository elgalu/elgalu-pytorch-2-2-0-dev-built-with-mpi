...
DEFINE_ncclDevKernel(AllReduce_Sum_bf16_RING_LL, ncclFuncAllReduce, FuncSum, __nv_bfloat16, NCCL_ALGO_RING, NCCL_PROTO_LL, 188)
#endif
#if CUDART_VERSION >= 11000 && __CUDA_ARCH__ >= 0
DEFINE_ncclDevKernel(AllReduce_Sum_bf16_TREE_LL, ncclFuncAllReduce, FuncSum, __nv_bfloat16, NCCL_ALGO_TREE, NCCL_PROTO_LL, 191)
#endif
#if CUDART_VERSION >= 11000 && __CUDA_ARCH__ >= 0
