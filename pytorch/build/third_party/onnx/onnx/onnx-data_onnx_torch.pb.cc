...
ONNX_API ::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<2> scc_info_MapProto_onnx_2fonnx_2ddata_5fonnx_5ftorch_2eproto =
...
namespace onnx_torch {
#if LANG_CXX11
  SequenceProto::SequenceProto(SequenceProto&& from) noexcept
    : SequenceProto() {
    *this = ::std::move(from);
  }
  MapProto::MapProto(MapProto&& from) noexcept
    : MapProto() {
    *this = ::std::move(from);
  }
  OptionalProto::OptionalProto(OptionalProto&& from) noexcept
    : OptionalProto() {
    *this = ::std::move(from);
  }
#endif
