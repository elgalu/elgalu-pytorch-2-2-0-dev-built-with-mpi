...
static PyObject * THPVariable__cslt_sparse_mm(PyObject* self_, PyObject* args, PyObject* kwargs)
{
  HANDLE_TH_ERRORS
  static PythonArgParser parser({
    "_cslt_sparse_mm(Tensor compressed_A, Tensor dense_B, Tensor? bias=None, ScalarType? out_dtype=None, bool transpose_result=False)",
  }, /*traceable=*/true);
  ...
  auto dispatch__cslt_sparse_mm = [](const at::Tensor & compressed_A, const at::Tensor & dense_B, const c10::optional<at::Tensor> & bias, c10::optional<at::ScalarType> out_dtype, bool transpose_result) -> at::Tensor {
    pybind11::gil_scoped_release no_gil;
    return at::_cslt_sparse_mm(compressed_A, dense_B, bias, out_dtype, transpose_result);
  };
  return wrap(dispatch__cslt_sparse_mm(_r.tensor(0), _r.tensor(1), _r.optionalTensor(2), _r.scalartypeOptional(3), _r.toBool(4)));
  Py_RETURN_NONE;
  END_HANDLE_TH_ERRORS
}
...
static PyObject * THPVariable__scaled_mm(PyObject* self_, PyObject* args, PyObject* kwargs)
{
  HANDLE_TH_ERRORS
  static PythonArgParser parser({
    "_scaled_mm(Tensor input, Tensor mat2, *, Tensor? bias=None, ScalarType? out_dtype=None, Tensor? scale_a=None, Tensor? scale_b=None, Tensor? scale_result=None, TensorList[2] out=None)",
  }, /*traceable=*/true);
  ...
  if (_r.isNone(7)) {
    ...
    auto dispatch__scaled_mm = [](const at::Tensor & self, const at::Tensor & mat2, const c10::optional<at::Tensor> & bias, c10::optional<at::ScalarType> out_dtype, const c10::optional<at::Tensor> & scale_a, const c10::optional<at::Tensor> & scale_b, const c10::optional<at::Tensor> & scale_result) -> ::std::tuple<at::Tensor,at::Tensor> {
      pybind11::gil_scoped_release no_gil;
      return at::_scaled_mm(self, mat2, bias, out_dtype, scale_a, scale_b, scale_result);
    };
    return wrap(dispatch__scaled_mm(_r.tensor(0), _r.tensor(1), _r.optionalTensor(2), _r.scalartypeOptional(3), _r.optionalTensor(4), _r.optionalTensor(5), _r.optionalTensor(6)));
  } else {
    ...
    auto out = _r.tensorlist_n<2>(7);
    auto dispatch__scaled_mm_out = [](at::Tensor & out, at::Tensor & out_amax, const at::Tensor & self, const at::Tensor & mat2, const c10::optional<at::Tensor> & bias, c10::optional<at::ScalarType> out_dtype, const c10::optional<at::Tensor> & scale_a, const c10::optional<at::Tensor> & scale_b, const c10::optional<at::Tensor> & scale_result) -> ::std::tuple<at::Tensor,at::Tensor> {
      pybind11::gil_scoped_release no_gil;
      return at::_scaled_mm_out(out, out_amax, self, mat2, bias, out_dtype, scale_a, scale_b, scale_result);
    };
    return wrap(dispatch__scaled_mm_out(out[0], out[1], _r.tensor(0), _r.tensor(1), _r.optionalTensor(2), _r.scalartypeOptional(3), _r.optionalTensor(4), _r.optionalTensor(5), _r.optionalTensor(6)));
  }
  Py_RETURN_NONE;
  END_HANDLE_TH_ERRORS
}
